...
(function init() {
  ...
  var playButtons = document.getElementsByClassName('slider__play');

  var _iterator = _createForOfIteratorHelper(playButtons),
      _step;

  try {
    var _loop = function _loop() {
      var playButton = _step.value;

      playButton.onclick = function (e) {
        e.preventDefault();
        var video = playButton.parentElement.getElementsByClassName('slider__video')[0];
        console.log(video);
        video.play();
      };
    };
